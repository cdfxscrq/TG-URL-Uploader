class Translation(object):
    START_TEXT = """This is an multisourcebot.
🎁Welcome🎏
© @multisource_bot"""
    RENAME_403_ERR = "Sorry. You are not permitted to rename this file."
    ABS_TEXT = " Please don't be selfish."
    UPGRADE_TEXT = "This is an @multisource_bot <a href='https://github.com/Ashok2umar/multisourcebot'>code</a>. \nStart @multisource_bot to know Paid Plans!"
...
URL | filename | username | password"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Thank you for using @multisource_bot"
...
Free users only 1 request per 10 minutes.
